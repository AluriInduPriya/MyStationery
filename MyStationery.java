...
public class MyStationery extends JFrame implements ActionListener {
    ...
    JComboBox<String> product_list, quantity_list;
    JList<String> product_bill, product_quantity, product_price;
    JButton add_product;
    ...
    public MyStationery() {
        ...
        product_and_price.put("Scale", "20");
        product_and_price.put("Notebook", "50");
        product_and_price.put("Highlighter", "30");
        product_and_price.put("Stapler", "60");
        product_and_price.put("Glue Stick", "25");
        product_and_price.put("Paper Clips", "15");
        product_and_price.put("Binder", "70");
